...
def load_data(root_dir: Union[str, Path]) -> Dict[str, Any]:
    ...
    Returns:
        Dict with structure:
        {
            ...
            "pages": {
                "page_name": {
                    "blocks": [{"pc": {...}, "mobile": {...}}, ...],
                    "pc_page_image": "base64...",
                    "mobile_page_image": "base64...",
                }
            }
        }
    ...
    for page_name in pages_map:
        page_list = []
        pc_page_image = None
        mobile_page_image = None
        
        # Load PC page image
        plat_dir = root / "pc"
        if plat_dir.is_dir():
            page_dir = plat_dir / page_name
            if page_dir.is_dir():
                pc_page_image = (
        ...
        if page_list:
            ...
            if pc_page_image:
                page_entry["pc_page_image"] = pc_page_image
            if mobile_page_image:
                page_entry["mobile_page_image"] = mobile_page_image
